  ...
  function enableForms() {
    document.querySelectorAll("form[data-web-to-lead]").forEach(function (form) {
      ...
      form.addEventListener("submit", function (event) {
        ...
        if (!window.NTESignature) { setStatus(form, "The signature pad could not load. Please refresh the page and try again.", "error"); return; }
        ...
        if (missingConfig.length) {
          setStatus(form, "The form is temporarily unavailable. Please contact the NTE team.", "error");
          return;
        }
        if (missing.length) {
          setStatus(form, "The form is temporarily unavailable. Please contact the NTE team.", "error");
